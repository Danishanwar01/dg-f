...
export default function CustomerPage() {
  ...
  const API_URL = `https://dg-b-1.onrender.com/api/customer/${user.id}`;
...
//     fetch(`https://dg-b-1.onrender.com/api/customer/${user.id}`)
//       .then(res => res.json())
//       .then(setCustomers)
//       .catch(() => setCustomers([]));
//   }
...
//       // Update
//       fetch(
//         `https://dg-b-1.onrender.com/api/customer/${user.id}/${editCustomer._id}`,
//         {
//           method: 'PUT',
...
//     fetch(
//       `https://dg-b-1.onrender.com/api/customer/${user.id}/${cust._id}`,
//       { method: 'DELETE' }
//     )
//       .then(res => res.json())
//       .then(() => fetchCustomers());
